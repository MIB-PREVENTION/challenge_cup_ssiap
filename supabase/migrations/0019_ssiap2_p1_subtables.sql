...
-- for the 26 hand-crafted challenge questions ssiap2-hc-p1-q1..q26.
-- Aligned with the existing questions.explanation and correct_* values.
begin;
...
insert into public.question_items (question_id, item_index, item_text) values
...
insert into public.question_pairs (question_id, pair_index, left_text, right_text) values
...
insert into public.question_categories (question_id, category_index, category_id, category_label) values
('ssiap2-hc-p1-q25', 0, 'fumees', '💨 Fumées'),
('ssiap2-hc-p1-q25', 1, 'chaleur', '🔥 Chaleur');

insert into public.question_category_items (question_id, item_index, item_text, correct_category) values
...
insert into public.question_decision_steps (question_id, step_index, step_question, options) values
('ssiap2-hc-p1-q26', 0,
