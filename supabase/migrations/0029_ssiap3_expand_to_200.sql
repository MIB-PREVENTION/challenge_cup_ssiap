-- SSIAP 3 — Expansion à 200 questions challenge (q27-q40 sur les 5 parties)
-- Cette migration ajoute 14 questions supplémentaires par partie (70 au total)
--
-- Vérification :
--   select pool, module_id, count(*) from public.questions
...
--
-- Couverture par partie (q27-q40 = 14 questions, 12 types) :
--   - 3 quiz (q27-q29)
--   - 1 true-false (q30)
